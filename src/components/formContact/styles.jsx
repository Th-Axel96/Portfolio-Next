...
export const styles = {
  ...
  // contact
  contact: {
    bgContentContact: "bg-white/10 pt-12 backdrop-blur-sm border-x-2 border-white/80 rounded-xl border-bleu-400 shadow-md shadow-blue-400 mb-16 mx-4 lg:mx-32 xl:mx-44 ",
    containerContact:
